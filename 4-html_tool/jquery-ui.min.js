...
!(function (t) {
                ...
                return (
                    t
                        ? this.length || 'instance' !== i
                            ...
                            : (n = void 0)
                        : (s.length &&
                              (i = V.widget.extend.apply(null, [i].concat(s))),
                          this.each(function () {
                              var t = V.data(this, a);
                              t
            ...
            option: function (t, e) {
                ...
                if ('string' == typeof t)
                    if (
                        ...
                        for (
                            s = o[t] = V.widget.extend({}, this.options[t]),
                                n = 0;
                            n < i.length - 1;
                            n++
                        )
                    ...
                    V.each(t, function (t, e) {
                        function i() {
                            if (
                                ...
                                return ('string' == typeof e ? r[e] : e).apply(
                                    r,
                                    arguments
                                );
                        }
            ...
            flip: {
                left: function (t, e) {
                    var i = e.within,
                        ...
                        a = -2 * e.offset[0];
                    r < 0
                        ? ((s = t.left + h + i + a + e.collisionWidth - n - s) <
                              0 ||
                              s < k(r)) &&
                          (t.left += h + i + a)
                        : 0 < l &&
                ...
                top: function (t, e) {
                    var i = e.within,
                        ...
                        a = -2 * e.offset[1];
                    r < 0
                        ? ((s = t.top + h + i + a + e.collisionHeight - n - s) <
                              0 ||
                              s < k(r)) &&
                          (t.top += h + i + a)
                        : 0 < l &&
        ...
        _mouseInit: function () {
            ...
            this.element
                ...
                .on('click.' + this.widgetName, function (t) {
                    if (
                        !0 ===
                        V.data(t.target, e.widgetName + '.preventClickEvent')
                    )
                        return (
                            V.removeData(
                                t.target,
    ...
    V.widget('ui.draggable', V.ui.mouse, {
        ...
        cancel: function () {
            return (
                this.helper.is('.ui-draggable-dragging')
                    ? this._mouseUp(
                          new V.Event('mouseup', { target: this.element[0] })
                      )
                    : this._clear(),
                this
            );
        ...
        _getHandle: function (t) {
            return (
                !this.options.handle ||
                !!V(t.target).closest(this.element.find(this.options.handle))
                    .length
            );
        },
                        ...
                        ? 'document' !== s.containment
                            ...
                            : (this.containment = [
                                  ...
                                  V(n).width() -
                                      ...
                                      this.margins.left,
                                  (V(n).height() ||
                                      n.body.parentNode.scrollHeight) -
                                      this.helperProportions.height -
                                      this.margins.top,
                              ])
                        : (this.containment = [
                    ...
                    (e.positionAbs = n.positionAbs),
                        ...
                        t
                            ? (e.isOver ||
                                  ...
                                  (e.fromOutside = n)),
                              e.currentItem &&
                                  (e._mouseDrag(i), (s.position = e.position)))
                            : e.isOver &&
                              ((e.isOver = 0),
                ...
                o !== a && 'HTML' !== o.tagName
                    ? ((s.axis && 'x' === s.axis) ||
                          ...
                          s.scrollSensitivity
                              ...
                              : t.pageY - i.overflowOffset.top <
                                    s.scrollSensitivity &&
                                (o.scrollTop = n =
                                    o.scrollTop - s.scrollSpeed)),
                      (s.axis && 'y' === s.axis) ||
                          (i.overflowOffset.left + o.offsetWidth - t.pageX <
                          s.scrollSensitivity
                              ? (o.scrollLeft = n =
                                    o.scrollLeft + s.scrollSpeed)
                    ...
                    : ((s.axis && 'x' === s.axis) ||
                          (t.pageY - V(a).scrollTop() < s.scrollSensitivity
                              ? (n = V(a).scrollTop(
                                    V(a).scrollTop() - s.scrollSpeed
                                ))
                              : V(window).height() -
                                    (t.pageY - V(a).scrollTop()) <
                                    s.scrollSensitivity &&
                                (n = V(a).scrollTop(
                                    V(a).scrollTop() + s.scrollSpeed
                                ))),
                      (s.axis && 'y' === s.axis) ||
                          (t.pageX - V(a).scrollLeft() < s.scrollSensitivity
                              ? (n = V(a).scrollLeft(
                                    V(a).scrollLeft() - s.scrollSpeed
                                ))
                              : V(window).width() -
                                    (t.pageX - V(a).scrollLeft()) <
                                    s.scrollSensitivity &&
                                (n = V(a).scrollLeft(
                                    V(a).scrollLeft() + s.scrollSpeed
                                )))),
        ...
        !(V.ui.ddmanager = {
            ...
            drop: function (t, e) {
                ...
                return (
                    V.each(
                        (
                            V.ui.ddmanager.droppables[t.options.scope] || []
                        ).slice(),
                        function () {
                            this.options &&
                                (!this.options.disabled &&
                ...
                t.element
                    ...
                    .on('scroll.droppable', function () {
                        t.options.refreshPositions ||
                            V.ui.ddmanager.prepareOffsets(t, e);
                    });
            },
            drag: function (n, o) {
                n.options.refreshPositions &&
                    V.ui.ddmanager.prepareOffsets(n, o),
                    V.each(
                        V.ui.ddmanager.droppables[n.options.scope] || [],
                        function () {
                            var t, e, i, s;
                            this.options.disabled ||
                                this.greedyChild ||
        ...
        _setupHandles: function () {
            ...
            if (
                ...
                for (
                    ...
                    (s =
                        'ui-resizable-' +
                        (t = String.prototype.trim.call(i[e]))),
                        (n = V('<div>')),
                ...
                for (e in ((t = t || this.element), this.handles))
                    this.handles[e].constructor === String
                        ? (this.handles[e] = this.element
                              ...
                              .first()
                              .show())
                        : (this.handles[e].jquery ||
                              this.handles[e].nodeType) &&
                ...
                this._helper &&
                    ...
                    (i =
                        parseFloat(o.element.css('left')) +
                            (o.position.left - o.originalPosition.left) ||
                        null),
                    (s =
                        parseFloat(o.element.css('top')) +
                            (o.position.top - o.originalPosition.top) || null),
                    n.animate ||
                        this.element.css(V.extend(e, { top: s, left: i })),
        ...
        _updateVirtualBoundaries: function (t) {
            var e,
                ...
                n = {
                    ...
                    maxHeight: this._isNumber(s.maxHeight)
                        ? s.maxHeight
                        : 1 / 0,
                };
            (this._aspectRatio || t) &&
        ...
        V.ui.plugin.add('resizable', 'containment', {
            start: function () {
                ...
                a &&
                    ...
                    /document/.test(o) || o === document
                        ...
                        : ((i = V(a)),
                          (s = []),
                          V(['Top', 'Right', 'Left', 'Bottom']).each(function (
                              t,
                              e
                          ) {
            ...
            resize: function (t) {
                ...
                r[0] !== document &&
                    ...
                    (i =
                        e.containerElement.get(0) ===
                        e.element.parent().get(0)),
                    (n = /relative|absolute/.test(
                        e.containerElement.css('position')
                    )),
                    i && n
                        ? ((e.offset.left =
                    ...
                    (n = Math.abs(
                        e.sizeDiff.width +
                            (e._helper
                                ? e.offset.left - a.left
                                : e.offset.left - s.left)
                    )),
                    (s = Math.abs(
                        e.sizeDiff.height +
                            (e._helper
    ...
    V.ui.resizable,
        ...
        V.widget('ui.sortable', V.ui.mouse, {
                ...
                return (
                    this.placeholder &&
                        ...
                        this.domPosition.prev
                            ...
                            : V(this.domPosition.parent).prepend(
                                  this.currentItem
                              )),
                    this
                );
            ...
            serialize: function (e) {
                ...
                return (
                    ...
                    V(t).each(function () {
                        var t = (
                            V(e.item || this).attr(e.attribute || 'id') || ''
            ...
            toArray: function (t) {
                ...
                return (
                    ...
                    e.each(function () {
                        i.push(
                            V(t.item || this).attr(t.attribute || 'id') || ''
                        );
                    }),
                    i
                );
            ...
            _getItemsAsjQuery: function (t) {
                ...
                if (r && t)
                    for (e = r.length - 1; 0 <= e; e--)
                        for (
                            i = (s = V(r[e], this.document[0])).length - 1;
                            0 <= i;
                            i--
                        )
            ...
            _refreshItems: function (t) {
                ...
                if (u && this.ready)
                    for (e = u.length - 1; 0 <= e; e--)
                        for (
                            i = (s = V(u[e], this.document[0])).length - 1;
                            0 <= i;
                            i--
                        )
                            (n = V.data(s[i], this.widgetFullName)) &&
                        ...
                        element: function () {
                            ...
                            return (
                                ...
                                'tbody' === n
                                    ...
                                    : 'img' === n &&
                                      t.attr('src', i.currentItem.attr('src')),
            ...
            _setContainment: function () {
                ...
                'parent' === i.containment &&
                    ...
                    /^(document|window|parent)$/.test(i.containment) ||
                        ...
                        (this.containment = [
                            e.left +
                                (parseInt(V(t).css('borderLeftWidth'), 10) ||
                                    0) +
                                (parseInt(V(t).css('paddingLeft'), 10) || 0) -
                                this.margins.left,
                            e.top +
                                (parseInt(V(t).css('borderTopWidth'), 10) ||
                                    0) +
        ...
        V.widget('ui.accordion', {
                ...
                t.preventDefault(),
                    (n && !e.collapsible) ||
                        ...
                        e.icons &&
                            ...
                            )._addClass(i, null, e.icons.header)),
                        n ||
                            (this._removeClass(
                                s,
                                'ui-accordion-header-collapsed'
                            ...
                            e.icons &&
                                ...
                                this._removeClass(
                                    ...
                                    null,
                                    e.icons.header
                                )._addClass(n, null, e.icons.activeHeader)),
                            this._addClass(
                                s.next(),
                                'ui-accordion-content-active'
                            )));
                        ...
                        : e.length &&
                          this.headers
                              .filter(function () {
                                  return (
                                      0 ===
                                      parseInt(V(this).attr('tabIndex'), 10)
                                  );
                              })
                              .attr('tabIndex', -1),
                    e
            ...
            _animate: function (t, i, e) {
                ...
                return (
                    (n =
                        (n = 'string' == typeof u ? u : n) ||
                        u.easing ||
                        c.easing),
                    (o =
                        (o = 'number' == typeof u ? u : o) ||
                        u.duration ||
                        c.duration),
                    i.length
                        ? t.length
        ...
        V.widget('ui.menu', {
            ...
            _scrollIntoView: function (t) {
                ...
                this._hasScroll() &&
                    ((i =
                        parseFloat(
                            V.css(this.activeMenu[0], 'borderTopWidth')
                        ) || 0),
                    (s =
                        parseFloat(V.css(this.activeMenu[0], 'paddingTop')) ||
                        0),
                    ...
                    e < 0
                        ...
                        : s < e + t &&
                          this.activeMenu.scrollTop(i + e - s + t));
            },
            blur: function (t, e) {
            ...
            select: function (t) {
                this.active =
                    this.active || V(t.target).closest('.ui-menu-item');
    ...
    V.widget('ui.autocomplete', {
        ...
        _create: function () {
            var i,
                ...
                t = 'input' === t;
            (this.isMultiLine =
                e || (!t && this._isContentEditable(this.element))),
        ...
        _suggest: function (t) {
            ...
            this._renderMenu(e, t),
                ...
                this._resizeMenu(),
                e.position(
                    V.extend({ of: this.element }, this.options.position)
                ),
    ...
    V.widget('ui.controlgroup', {
        ...
        refresh: function () {
            ...
            this._addClass(
                ...
                this._initWidgets(),
                (n = this.childWidgets),
                (n = this.options.onlyVisible ? n.filter(':visible') : n)
                    .length &&
        ...
        V.extend(b.prototype, {
            ...
            _attachDatepicker: function (t, e) {
                ...
                t.id || ((this.uuid += 1), (t.id = 'dp' + this.uuid)),
                    ((i = this._newInst(V(t), n)).settings = V.extend(
                        {},
                        e || {}
                    )),
                    'input' === s
            ...
            _doKeyDown: function (t) {
                ...
                if (((s._keyEvent = !0), V.datepicker._datepickerShowing))
                    switch (t.keyCode) {
                        ...
                        case 35:
                            (t.ctrlKey || t.metaKey) &&
                                V.datepicker._clearDate(t.target),
                                (n = t.ctrlKey || t.metaKey);
                            break;
                        case 36:
                            (t.ctrlKey || t.metaKey) &&
                                V.datepicker._gotoToday(t.target),
                                (n = t.ctrlKey || t.metaKey);
                            break;
                        case 37:
                            (t.ctrlKey || t.metaKey) &&
                        ...
                        !1 !==
                            ...
                            n.inline ||
                                ...
                                V.effects && V.effects.effect[i]
                                    ? n.dpDiv.show(
                                          i,
                                          V.datepicker._get(n, 'showOptions'),
                                          s
                                      )
                                    : n.dpDiv[i || 'show'](i ? s : null),
                                V.datepicker._shouldFocusInput(n) &&
                        ...
                        b = function (t, e, i) {
                            ...
                            if (
                                (V.each(e, function (t, e) {
                                    var i = e[1];
                                    if (
                                        n.substr(a, i.length).toLowerCase() ===
                                        i.toLowerCase()
                                    )
            ...
            _get: function (t, e) {
                return (void 0 !== t.settings[e] ? t.settings : this._defaults)[
                    e
                ];
            },
                ...
                t.dpDiv.find('[data-handler]').map(function () {
                    var t = {
                        ...
                        selectMonth: function () {
                            return (
                                V.datepicker._selectMonthYear(i, this, 'M'), !1
                            );
                        },
                        selectYear: function () {
                            return (
                                V.datepicker._selectMonthYear(i, this, 'Y'), !1
                            );
                        },
                    };
                    V(this).on(
            ...
            _generateHTML: function (t) {
                ...
                for (
                    t.drawMonth = K,
                        ...
                        A = F
                            ? this.formatDate(A, W, this._getFormatConfig(t))
                            : A,
                        R = '',
                        t.inline ||
                            (R = V('<button>')
                    ...
                    for (_ = '', this.maxRows = 4, v = 0; v < L[1]; v++) {
                        ...
                        for (
                            w += x + '</tr></thead><tbody>',
                                ...
                                C =
                                    (this._getFirstDayOfMonth(U, K) - n + 7) %
                                    7,
                                D = Math.ceil((C + D) / 7),
                            ...
                            for (
                                ...
                                (S = c
                                    ? c.apply(t.input ? t.input[0] : null, [T])
                                    : [!0, '']),
                                    (z =
                                        ((H = T.getMonth() !== K) && !d) ||
                                        !S[0] ||
    ...
    V.widget('ui.dialog', {
        ...
        _createButtonPane: function () {
            (this.uiDialogButtonPane = V('<div>')),
                ...
                (this.uiButtonSet = V('<div>').appendTo(
                    this.uiDialogButtonPane
                )),
    ...
    V.ui.dialog,
                ...
                this.valueDiv
                    ...
                    this.indeterminate
                        ? (this.element.removeAttr('aria-valuenow'),
                          this.overlayDiv ||
                              ((this.overlayDiv = V('<div>').appendTo(
                                  this.valueDiv
                              )),
                              this._addClass(
                                  this.overlayDiv,
                ...
                _documentClick: {
                    mousedown: function (t) {
                        this.isOpen &&
                            (V(t.target).closest(
                                '.ui-selectmenu-menu, #' +
                                    V.escapeSelector(this.ids.button)
                            ).length ||
                                this.close(t));
                    },
                },
        ...
        V.widget('ui.slider', V.ui.mouse, {
            ...
            _values: function (t) {
                ...
                if (arguments.length)
                    return (
                        (t = this.options.values[t]),
                        (t = this._trimAlignValue(t))
                    );
                if (this._hasMultipleValues()) {
                    for (
                        e = this.options.values.slice(), i = 0;
                        i < e.length;
                        i += 1
                    )
            ...
            'mousedown .ui-spinner-button': function (t) {
                ...
                (e =
                    ...
                    !1 !== this._start(t) &&
                        this._repeat(
                            null,
                            V(t.currentTarget).hasClass('ui-spinner-up')
                                ? 1
                                : -1,
                            t
                        );
    ...
    V.widget('ui.tabs', {
        ...
        refresh: function () {
            ...
            (t.disabled = V.map(e.filter('.ui-state-disabled'), function (t) {
                ...
                !1 !== t.active && this.anchors.length
                    ? this.active.length &&
                      !V.contains(this.tablist[0], this.active[0])
            ...
            (this.tablist = this._getList().attr('role', 'tablist')),
                ...
                this.tablist
                    ...
                    .on(
                        ...
                        '.ui-tabs-anchor',
                        function () {
                            V(this).closest('li').is('.ui-state-disabled') &&
                                this.blur();
                        }
                    ),
                  ...
                  this.panels
                      .each(function () {
                          V(this).height(
                              Math.max(
                                  0,
                                  i - V(this).innerHeight() + V(this).height()
                              )
                          );
                      })
                      .css('overflow', 'auto'))
        ...
        _activate: function (t) {
            ...
            t[0] !== this.active[0] &&
                ((t = (t = !t.length ? this.active : t).find(
                    '.ui-tabs-anchor'
                )[0]),
                this._eventHandler({
                    target: t,
                ...
                t &&
                    ...
                    e.parents().each(function () {
                        ...
                        e.data('ui-tooltip-open') &&
                            (((t = V.Event('blur')).target = t.currentTarget =
                                this),
                            i.close(t, !0)),
                            e.attr('title') &&
                                (e.uniqueId(),
            ...
            i &&
                ((s = this._find(e))
                    ...
                    : (e.is('[title]') &&
                      ...
                      (i = V('<div>').html(
                          n.find('.ui-tooltip-content').html()
                      ))
                          .removeAttr('name')
                          .find('[name]')
                          .removeAttr('name'),
                      ...
                      this.options.track && t && /^mouse/.test(t.type)
                          ...
                          : n.position(
                                V.extend({ of: e }, this.options.position)
                            ),
                      n.hide(),
                        ...
                        if (
                            ...
                            if (
                                ...
                                for (
                                    ...
                                    try {
                                        (n = H.css(s, 'backgroundColor')),
                                            (s = s.parentNode);
                                    } catch (t) {}
                                e = e.blend(
                                    n && 'transparent' !== n ? n : '_default'
                                );
                            }
                            e = e.toRgbaString();
                        }
    ...
    (V.effects = { effect: {} }),
        ...
        (V.effects.animateClass = function (n, t, e, i) {
            ...
            return this.queue(function () {
                var i = V(this),
                    t = i.attr('class') || '',
                    e = (e = o.children ? i.find('*').addBack() : i).map(
                        function () {
    ...
    (R = V.effects),
        ...
        V.effects.define('drop', 'hide', function (t, e) {
            ...
            V.effects.createPlaceholder(i),
                (n =
                    t.distance ||
                    i['top' == o ? 'outerHeight' : 'outerWidth'](!0) / 2),
                (l[o] = a + n),
